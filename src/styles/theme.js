export const theme = {
    ...
    input: {
        text: "w-full p-2 bg-brown-50 border border-brown-200 rounded-lg text-sm focus:border-brown-500 focus:ring-1 focus:ring-brown-500 outline-none transition-all",
        textarea: "w-full p-2 bg-brown-50 border border-brown-200 rounded-lg text-sm h-16 resize-none focus:border-brown-500 focus:ring-1 focus:ring-brown-500 outline-none transition-all",
        select: "w-full border border-brown-300 rounded-lg p-2 text-sm bg-white",
